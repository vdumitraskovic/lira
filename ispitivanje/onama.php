...
<?php include 'inc/head.php'; ?>
        <div class="container">
            ...
            <div id="main" class="twelve columns omega">
				<header>
                    <h1 class="title">Laboratorija za ispitivanje radioaktivnosti uzoraka i doze jonizujućeg i nejonizujućeg zračenja</h1>
                </header>
                              
                <article class="fourteen offset-by-one columns">
                <h2>Zaposleni u našoj laboratoriji:</h2>
                    <ul>
                    <li><strong>   Prof.dr Miroslav Vesković,</strong> redovni profesor, uža naučna oblast:nuklearna fizika, šef laboratorije</li>
                    <li><strong>   Prof.dr Ištvan Bikit,     </strong> redovni profesor u penziji, uža naučna oblast:nuklearna fizika, tehnički rukovodilac laboratorije</li>
                    <li><strong>   Prof.dr Jaroslav Slivka,  </strong> redovni profesor u penziji, uža naučna oblast:nuklearna fizika</li>
                    <li><strong>   Prof.dr Miodrag Krmar,    </strong> redovni profesor, uža naučna oblast:nuklearna fizika</li>
                    ...
                    <li><strong>   Mile Ugarčina,            </strong> tehnički saradnik za nejonizujuće zračenje</li>
